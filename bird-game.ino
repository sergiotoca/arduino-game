...
#define HERO_POSITION_MOVE_3 5       // MOVE is on upper row
#define HERO_POSITION_MOVE_4 6       // MOVE is on upper row
#define HERO_POSITION_MOVE_5 7       // MOVE is on upper row
#define HERO_POSITION_MOVE_6 8       // MOVE is on upper row
...
bool drawHero(byte position, char* terrainUpper, char* terrainLower, unsigned int score) {
  ...
  switch (position) {
    ...
    case HERO_POSITION_MOVE_8:
      ...
      lower = SPRITE_MOVE;
      break;
    case HERO_POSITION_MOVE_2:
    case HERO_POSITION_MOVE_7:
      upper = SPRITE_MOVE_UPPER;
      lower = SPRITE_MOVE_LOWER;
      break;
    case HERO_POSITION_MOVE_3:
    case HERO_POSITION_MOVE_4:
    case HERO_POSITION_MOVE_5:
    case HERO_POSITION_MOVE_6:
      upper = SPRITE_MOVE;
